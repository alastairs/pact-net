...
{
    internal sealed class WindowsMockServer : IMockProvider
    {
        private const string PactMockServerDllName =
            @"Rust\ForeignFunctionInterface\lib\libpact_mock_server_ffi-windows-x86_64.dll";

        private int _port;

        internal WindowsMockServer() => init();
